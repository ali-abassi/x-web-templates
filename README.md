<div align="center">
  ...
  <p>20 templates · Editable HTML, CSS &amp; JavaScript · Free downloads</p>
...
<img src="docs/assets/workflow.svg" width="920" alt="Find a great design and save its source; pass the reference to Astra; check the result and share the editable template with credit." />
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>AnimoraAI</h3>
      <a href="https://x-web-templates.pages.dev/animora/"><img src="gallery/assets/animora.png" width="440" alt="AnimoraAI template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Travio</h3>
      <a href="https://x-web-templates.pages.dev/travio/"><img src="gallery/assets/travio.png" width="440" alt="Travio template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>NeuroLink</h3>
      <a href="https://x-web-templates.pages.dev/neurolink/"><img src="gallery/assets/neurolink.png" width="440" alt="NeuroLink template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Swift AI</h3>
      <a href="https://x-web-templates.pages.dev/swift-ai/"><img src="gallery/assets/swift-ai.png" width="440" alt="Swift AI template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Arto+</h3>
      <a href="https://x-web-templates.pages.dev/arto/"><img src="gallery/assets/arto.png" width="440" alt="Arto+ template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Verto</h3>
      <a href="https://x-web-templates.pages.dev/verto/"><img src="gallery/assets/verto.png" width="440" alt="Verto template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Olympus</h3>
      <a href="https://x-web-templates.pages.dev/olympus/"><img src="gallery/assets/olympus.png" width="440" alt="Olympus template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Wandor</h3>
      <a href="https://x-web-templates.pages.dev/wandor/"><img src="gallery/assets/wandor.png" width="440" alt="Wandor template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <a href="https://x-web-templates.pages.dev/alpine-notes/"><img src="gallery/assets/alpine-notes.jpg" width="440" alt="Scribblit / Alpine Notes template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      ...
      <a href="https://x-web-templates.pages.dev/rainbow-venture/"><img src="gallery/assets/rainbow-venture.jpg" width="440" alt="Bird / Rainbow Venture template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Bloop</h3>
      <a href="https://x-web-templates.pages.dev/bloop/"><img src="gallery/assets/bloop.jpg" width="440" alt="Bloop template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Furion</h3>
      <a href="https://x-web-templates.pages.dev/furion/"><img src="gallery/assets/furion.jpg" width="440" alt="Furion template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>HorizonX</h3>
      <a href="https://x-web-templates.pages.dev/horizonx/"><img src="gallery/assets/horizonx.png" width="440" alt="HorizonX template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Pixel World</h3>
      <a href="https://x-web-templates.pages.dev/pixel-world/"><img src="gallery/assets/pixel-world.png" width="440" alt="Pixel World template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>BuzzKit</h3>
      <a href="https://x-web-templates.pages.dev/buzzkit/"><img src="gallery/assets/buzzkit.png" width="440" alt="BuzzKit template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Clipdock</h3>
      <a href="https://x-web-templates.pages.dev/clipdock/"><img src="gallery/assets/clipdock.png" width="440" alt="Clipdock template screenshot" /></a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <a href="https://x-web-templates.pages.dev/grid-driver/"><img src="gallery/assets/grid-driver.png" width="440" alt="GRID01 / Leo Mazzi template screenshot" /></a>
    ...
    <td width="50%" valign="top">
      <h3>Aster</h3>
      <a href="https://x-web-templates.pages.dev/aster/"><img src="gallery/assets/aster.png" width="440" alt="Aster template screenshot" /></a>
...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <h3>Chatsheet</h3>
      <a href="https://x-web-templates.pages.dev/chatsheet/"><img src="gallery/assets/chatsheet.png" width="440" alt="Chatsheet automation hero screenshot" /></a>
      <p>Floating app tiles and a dimensional blue automation hub.</p>
      <p><a href="https://x-web-templates.pages.dev/chatsheet/">Live preview ↗</a> · <a href="https://x-web-templates.pages.dev/downloads/chatsheet.zip">Download ZIP</a> · <a href="templates/chatsheet/">Source</a></p>
      <p><sub>Reference: <a href="https://x.com/marcelkargul/status/2098877780293271731">Marcel Kargul</a></sub></p>
    </td>
  </tr>
</table>
...
- **Chatsheet reference:** [Marcel Kargul — original post](https://x.com/marcelkargul/status/2098877780293271731). One light automation hero with independently authored SVG illustration and CSS motion.
...
```text
Built 20 independent sites, the gallery, and reproducible ZIPs.
PASS: 21 pages, local links/anchors, image attributes, JS syntax, and 20 exact ZIPs.
```
...
The build checks cover all **20 templates and 20 ZIPs**: generated page inventory, local links and anchors, image attributes, JavaScript syntax, and exact ZIP parity. They are not a certification of every browser, accessibility scenario, backend integration, or reference-perfect design. Per-template browser evidence and remaining differences are retained under `evidence/`.
