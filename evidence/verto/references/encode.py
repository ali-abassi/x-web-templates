...
r=Path('/Users/aliabassi/Documents/ChatGPT/AI Designer/x-web-templates');source=r/'evidence/verto/references/motion-source.mp4';target=r/'templates/verto/dist/assets/motion.mp4'
subprocess.run(['ffmpeg','-hide_banner','-loglevel','error','-i',str(source),'-an','-c:v','libx264','-crf','20','-preset','medium','-g','12','-keyint_min','12','-sc_threshold','0','-pix_fmt','yuv420p','-movflags','+faststart',str(target)],check=True)
